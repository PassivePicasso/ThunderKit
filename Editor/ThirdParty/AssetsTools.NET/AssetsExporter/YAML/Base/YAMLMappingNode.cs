...
namespace AssetsExporter.YAML
{
	public sealed class YAMLMappingNode : YAMLNode
	{
		...
		public void Add(string key, YAMLNode value)
		{
			...
			InsertEnd(keyNode, value);
			if (value.extraNamedNodesInParent != null)
			{
				var extraChilds = value.extraNamedNodesInParent;
				value.extraNamedNodesInParent = null;
				foreach (var extraChild in extraChilds)
				{
					InsertEnd(new YAMLScalarNode(extraChild.Key), extraChild.Value);
				}
			}
		}
