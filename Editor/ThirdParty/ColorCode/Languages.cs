...
namespace ColorCode
{
    ...
    public class Languages
    {
        ...
        public readonly Dictionary<string, ILanguage> LoadedLanguages;
        public readonly Dictionary<string, CompiledLanguage> CompiledLanguages;
        ...
        public ILanguage FindById(string id)
        {
