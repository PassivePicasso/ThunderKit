PathReferences are a ComposableObject that provide tools to target paths,  use them to coordinate the deployment of files for your Manifests and Pipelines.
